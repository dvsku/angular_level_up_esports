...
@Component({
    selector: 'app-edit-shop-product',
    templateUrl: './product.template.html',
    styleUrls: ['./product.style.sass']
})
export class EditShopProductComponent implements OnInit, OnDestroy, AfterViewInit, ImagesHandler {
