...
export class ProductCatalogService {
  ...
  public addNewProductCatalog(productCatalog : ProductCatalog) : Observable<ProductCatalog> {
    const url = `${this.adminUrl}/new`;
    return this.httpClient.post<ProductCatalog>(url , productCatalog);
  }

  public editExistingProductCatalog(id : number , productCatalog : ProductCatalog) : Observable<ProductCatalog> {
